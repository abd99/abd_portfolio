...
const List<Project> projectsList = [
  ...
  Project(
    ...
    description: [
      'Mobile app for a client health product focused on daily sodium tracking, meal logging, charts, and diet guidance',
      '- Dashboard with daily sodium budgets, charted progress, and meal-by-meal breakdowns.',
      '- Food search and logging, weekly history, and low-sodium recommendations.',
      '- Multi-step onboarding, social sign-in, profile setup, and offline-first storage with SQLite.',
    ],
    year: '2021',
